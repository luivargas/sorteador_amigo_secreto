...
import 'package:sorteador_amigo_secreto/core/ui/components/my_token_form_field.dart';
...
class _ValidateTokenScreenState extends State<ValidateTokenScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthCubit, AuthState>(
      ...
      listener: (context, state) => context.goNamed('nav_bar'),
      child: Form(
        key: _formKey,
        child: Scaffold(
              ...
              child: BlocBuilder<AuthCubit, AuthState>(
                builder: (context, state) {
                  ...
                  return Column(
                    ...
                    spacing: 20,
                    children: [
                      MyEmailFormField(controller: _emailController, readOnly: true,),
