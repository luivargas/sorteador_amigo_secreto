    ...
    return BottomBar(
      ...
      icon: (width, height) => Center(
        child: IconButton(
          ...
          onPressed: null,
          icon: Icon(Icons.arrow_upward_rounded, color: colors, size: width),
        ),
      ),
      ...
      showIcon: true,
      width: 250,
      barColor: SecretSantaColors.accent.withAlpha(180),
      start: 2,
      end: 0,
      offset: 10,
      ...
      child: TabBar(
        ...
        tabs: [
          SizedBox(
            height: 55,
            width: 40,
            child: Center(child: Icon(Icons.home, color: colors)),
          ),
          SizedBox(
            height: 55,
            width: 40,
