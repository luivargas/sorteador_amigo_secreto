...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get allParticipantsList => 'Todos los Participantes';

  @override
  String participantsSubtitle(int count) {
    return 'Personas registradas en el grupo: $count';
  }
  ...
  String groupUpdatedSuccess(String name) {
    return '¡Grupo $name actualizado con éxito!';
  }

  @override
  String groupDeletedSuccess(String name) {
    return '¡Grupo $name eliminado con éxito!';
  }

  @override
  String resendEmailSuccess(String name) {
    return '¡Correo reenviado con éxito a $name!';
  }

  @override
  String get resendEmailInvalid =>
      'No fue posible reenviar el correo. El participante no tiene un correo electrónico válido registrado.';

  @override
  String get contactReviewTitle => 'Revisar contactos';
  ...
  @override
  String get whatsappPremiumCardSubtitle => 'Resultado en WhatsApp';

  @override
  String get whatsappPremiumAlertStart =>
      'La recepción del resultado por WhatsApp es exclusiva para Grupos Premium';

  @override
  String get whatsappPremiumAlertEnd =>
      'Para recibir el resultado del amigo secreto en WhatsApp, es necesario que el grupo tenga el plan Premium activo y que los participantes envíen un mensaje a nuestro robot después del sorteo.';

  @override
  String get whatsappActivatedTitle => 'WhatsApp activado en este grupo.';

  @override
  String get whatsappActivatedAlertMessage =>
      'Comparte este enlace de WhatsApp con los participantes. Cada persona debe enviar un mensaje usando el número que registró para recibir el nombre de su amigo secreto.';
  ...
  String get copyright =>
      '© 2009–2026 Todos los derechos reservados.\nSorteador.com.br';
}
